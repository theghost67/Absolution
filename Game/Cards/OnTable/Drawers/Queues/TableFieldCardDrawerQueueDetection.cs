...
namespace Game.Cards
{
    public class TableFieldCardDrawerQueueDetection : TableFieldCardDrawerQueueElement
    {
        ...
        public override async UniTask PlayAnimation(GameObject prefab)
        {
            ...
            prefabHeader.text = canSee ? Translator.GetString("table_field_card_drawer_queue_detection_1") : Translator.GetString("table_field_card_drawer_queue_detection_2"); 
