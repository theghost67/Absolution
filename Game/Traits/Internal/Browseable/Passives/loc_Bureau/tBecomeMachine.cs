...
namespace Game.Traits
{
    ...
    public class tBecomeMachine : PassiveTrait
    {
        ...
        protected override string DescContentsFormat(TraitDescriptiveArgs args)
        {
            ...
            return $"<color>При появлении карты <nobr><u>{cardName}</u></nobr> на вражеской стороне (П{PRIORITY})</color>\n" +
                   $"Уменьшает свою силу на {_strengthF.Format(args.stacks)} и инициативу на {_moxieF.Format(args.stacks, true)}.";
        }
